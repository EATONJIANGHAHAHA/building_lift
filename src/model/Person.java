...
public class Person {
    ...
    private StringProperty aboardStatus = new SimpleStringProperty();
    ...
    public String getAboardStatus(){
        return aboardStatus.get();
    }public StringProperty aboardStatusProperty(){
        return aboardStatus;
    }
